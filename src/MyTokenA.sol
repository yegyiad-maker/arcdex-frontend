...
contract MyTokenA is ERC20 {
    /**
     * @notice Constructor for MyToken A (MYTA).
     * @param initialSupply The whole token amount (e.g., 1,000,000) to mint.
     * It will be scaled by 10^18 (or the token's decimals).
     */
    constructor(uint256 initialSupply) ERC20("MyToken A", "MYTA") {
        // Mints the scaled supply (initialSupply * 10^18) to the deployer (msg.sender)
